...
export function HeatMapCanvas({ puntos, editable = false, onAddPunto, className }: HeatMapCanvasProps) {
        ...
        <div className="flex gap-2">
          <button
            ...
            className={cn(
              ...
              modoAnotado ? "bg-green-600 text-white" : "border border-border bg-card text-muted-foreground"
            )}
          >
            Gol
          </button>
          <button
            ...
            className={cn(
              "rounded-md px-3 py-1 text-xs font-medium transition-colors",
              !modoAnotado ? "bg-red-600 text-white" : "border border-border bg-card text-muted-foreground"
            )}
          >
            Fallo
          </button>
