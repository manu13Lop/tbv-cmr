...
export default function MensajesError({
  ...
  useEffect(() => {
    log.error({ err: error }, 'Error en mensajes');
  }, [error]);
  ...
  return (
    <div className="flex min-h-[40vh] items-center justify-center p-6">
      <div className="max-w-md text-center">
        ...
        <h2 className="mb-2 text-lg font-bold">Error en Mensajes</h2>
        <p className="text-muted-foreground mb-4 text-sm">
          No se pudieron cargar los mensajes. Verifica tu conexión e intenta de nuevo.
        </p>
        <button
          onClick={reset}
