...
export default function SanitarioError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    log.error({ err: error }, 'Error en sanitario');
  }, [error]);
  ...
  return (
    <div className="flex min-h-[40vh] items-center justify-center p-6">
      <div className="max-w-md text-center">
        ...
        <h2 className="mb-2 text-lg font-bold">Error en Sanitario</h2>
        <p className="text-muted-foreground mb-4 text-sm">
          No se pudieron cargar los datos sanitarios. Intenta de nuevo.
        </p>
        <button
          onClick={reset}
