...
export default async function FichaScoutingDetallePage({
  params,
}: {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-primary text-2xl font-bold">{nombre}</h1>
      ...
      <h2 className="text-primary mb-3 text-lg font-bold">Evolución cronológica</h2>
        ...
        <div className="border-border mb-8 rounded-lg border">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {informes.map((i) => (
                  <tr key={i.id} className="border-border hover:bg-muted/50 border-t">
      ...
      {puedeEditar && (
        ...
        >
          ...
          <div>
            ...
            <input
              name="club_actual"
              defaultValue={ficha.club_actual ?? ''}
              className="border-border bg-background w-full rounded-md border p-2 text-sm"
            />
          </div>
          <div>
            ...
            <textarea
              ...
              rows={3}
              defaultValue={ficha.notas_generales ?? ''}
              className="border-border bg-background w-full rounded-md border p-2 text-sm"
            />
          </div>
