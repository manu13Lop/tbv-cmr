...
const POSICIONES = ["", "Portera", "Lateral izquierdo", "Lateral derecho", "Central", "Extremo izquierdo", "Extremo derecho", "Pivote"] as const
...
const RESULTADO_RECONOCIMIENTO = ["pendiente", "apto", "no_apto"] as const
...
export const crearSesionPsicologiaSchema = z.object({
